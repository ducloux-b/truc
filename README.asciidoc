...
=========================
Changement dans la branche hotfix.

Je suis un changement de la branche develop

Je suis un changement dans spring.

Pendant ce teps, dans Spring...plus tard...en SSH...
